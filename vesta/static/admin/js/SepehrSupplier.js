            ...
            $.ajax({
                ...
                success: function(response){
                    if (response.status){
                        ...
                        url = "http://185.201.49.52/static/admin/captcha/" + response.url_pic;
                        // url = "http://185.201.49.52:8080/static/admin/captcha/" + response.url_pic;
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if (response.status == true){
                        ...
                        $(".info").css("display","block");
                        url = "http://185.201.49.52/static/admin/captcha/" + response.url_pic;
                        // let url = "http://185.201.49.52:8080/static/admin/captcha/" + response.url_pic;
                        $("#img_captcha").attr("src",url);
                        $("#text_captcha").focus();
                    }
                },
